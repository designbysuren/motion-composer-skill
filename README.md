...
Claude becomes:
- **Creative Director** — concept, theme, emotional arc
- - **Motion Designer** — animation principles, timing, easing
  - - **Video Editor** — pacing, scene structure, editing rhythm
    - - **Cinematic Storyboard Artist** — scene JSON, visual direction, camera language
      - - **Remotion / CapCut Orchestrator** — execution-ready output
